...
// This program reads from the Mag C on SoftSerial (pins 9, 10)
// and connects to a Serial terminal (compter hyperterminal)
// on Serial1  baud = 38,400

//It is writing to the SD card and had two I2C devices
...
void setup() {
    // Initialise I2C communication as MASTER for T RH I2C
 Wire.begin();
